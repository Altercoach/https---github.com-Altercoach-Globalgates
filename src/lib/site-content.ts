...
export const DEFAULT_SITE_CONTENT: SiteData = {
  ...
  services: [
    { id: 'svc-funnel', title: { es: 'Creación de Embudo de Ventas', en: 'Sales Funnel Creation', fr: 'Création d\'Entonnoir de Vente' }, bullets: [
    ...
    { id: 'svc-branding', title: { es: 'Posicionamiento de Marca', en: 'Brand Positioning', fr: 'Positionnement de Marque' }, bullets: [
    ...
    { id: 'svc-content', title: { es: 'Marketing de Contenidos', en: 'Content Marketing', fr: 'Marketing de Contenu' }, bullets: [
    ...
    { id: 'svc-loyalty', title: { es: 'Fidelización de Clientes', en: 'Customer Loyalty', fr: 'Fidélisation de la Clientèle' }, bullets: [
    ...
    { id: 'svc-research', title: { es: 'Investigación de Mercado', en: 'Market Research', fr: 'Étude de Marché' }, bullets: [
