...
export const DEFAULT_SITE_CONTENT: SiteData = {
  ...
  services: [
    ...
    { id: 'svc-branding', visible: true, title: { es: 'Diseño Gráfico y Marca', en: 'Graphic Design and Branding', fr: 'Design Graphique et Image de Marque' }, bullets: [
     ...
     { id: 'svc-all-in-one', visible: false, title: { es: 'Paquetes Integrales Todo-en-Uno', en: 'All-in-One Comprehensive Packages', fr: 'Packages Complets Tout-en-Un' }, bullets: [
  ...
  products: [
    { 
      id: 'prod_sm_1', name: { es: 'Impulso Esencial (1 Red)', en: 'Essential Boost (1 Network)', fr: 'Boost Essentiel (1 Réseau)' }, type: 'sub', price: 500,
    ...
    { 
      id: 'prod_sm_2', name: { es: 'Dúo Conexión (2 Redes)', en: 'Connection Duo (2 Networks)', fr: 'Duo Connexion (2 Réseaux)' }, type: 'sub', price: 750,
      badge: { es: 'Social Media', en: 'Social Media', fr: 'Réseaux Sociaux' },
    ...
    { 
      id: 'prod_sm_3', name: { es: 'Tridente Digital (3 Redes)', en: 'Digital Trident (3 Networks)', fr: 'Trident Numérique (3 Réseaux)' }, type: 'sub', price: 1000,
      badge: { es: 'Social Media', en: 'Social Media', fr: 'Réseaux Sociaux' },
    ...
    { 
      id: 'prod_sm_4', name: { es: 'Presencia Profesional (4 Redes)', en: 'Professional Presence (4 Networks)', fr: 'Présence Professionnelle (4 Réseaux)' }, type: 'sub', price: 1500,
      badge: { es: 'Social Media', en: 'Social Media', fr: 'Réseaux Sociaux' },
    ...
    { 
      id: 'prod_sm_5', name: { es: 'Dominio Omni-Channel (6 Redes)', en: 'Omni-Channel Domination (6 Networks)', fr: 'Domination Omni-Canal (6 Réseaux)' }, type: 'sub', price: 2500,
      badge: { es: 'Social Media', en: 'Social Media', fr: 'Réseaux Sociaux' },
    ...
    { 
      id: 'prod_sm_vip_1', name: { es: 'Impulso Esencial VIP (1 Red)', en: 'Essential Boost VIP (1 Network)', fr: 'Boost Essentiel VIP (1 Réseau)' }, type: 'sub', price: 600,
    ...
    { 
      id: 'prod_sm_vip_2', name: { es: 'Dúo Conexión VIP (2 Redes)', en: 'Connection Duo VIP (2 Networks)', fr: 'Duo Connexion VIP (2 Réseaux)' }, type: 'sub', price: 850,
      badge: { es: 'Gestión VIP', en: 'VIP Management', fr: 'Gestion VIP' },
    ...
    { 
      id: 'prod_sm_vip_3', name: { es: 'Tridente Digital VIP (3 Redes)', en: 'Digital Trident VIP (3 Networks)', fr: 'Trident Numérique VIP (3 Réseaux)' }, type: 'sub', price: 1200,
      badge: { es: 'Gestión VIP', en: 'VIP Management', fr: 'Gestion VIP' },
     ...
     { 
      id: 'prod_sm_vip_4', name: { es: 'Presencia Profesional VIP (4 Redes)', en: 'Professional Presence VIP (4 Networks)', fr: 'Présence Professionnelle VIP (4 Réseaux)' }, type: 'sub', price: 1800,
      badge: { es: 'Gestión VIP', en: 'VIP Management', fr: 'Gestion VIP' },
     ...
     { 
      id: 'prod_sm_vip_5', name: { es: 'Dominio Omni-Channel VIP (6 Redes)', en: 'Omni-Channel Domination VIP (6 Networks)', fr: 'Domination Omni-Canal VIP (6 Réseaux)' }, type: 'sub', price: 3000,
      badge: { es: 'Gestión VIP', en: 'VIP Management', fr: 'Gestion VIP' },
    ...
    { 
      id: 'prod_cp_1', name: { es: 'Diseño Individual', en: 'Single Design', fr: 'Design Unique' }, type: 'one', price: 50,
    ...
    { 
      id: 'prod_cp_2', name: { es: 'Paquete de Contenido 15', en: 'Content Pack 15', fr: 'Pack Contenu 15' }, type: 'one', price: 250,
      badge: { es: 'Contenido', en: 'Content', fr: 'Contenu' },
    ...
    { 
      id: 'prod_cp_3', name: { es: 'Paquete de Contenido 20', en: 'Content Pack 20', fr: 'Pack Contenu 20' }, type: 'one', price: 300,
      badge: { es: 'Contenido', en: 'Content', fr: 'Contenu' },
    ...
    { 
      id: 'prod_cp_4', name: { es: 'Paquete de Contenido 30', en: 'Content Pack 30', fr: 'Pack Contenu 30' }, type: 'one', price: 350,
      badge: { es: 'Contenido', en: 'Content', fr: 'Contenu' },
    ...
    { 
     ...
     { 
      id: 'prod_aio_1', name: { es: 'Portal Maestro Digital', en: 'Digital Master Gateway', fr: 'Portail Maître Numérique' }, type: 'sub', price: 1500,
     ...
     { 
      id: 'prod_brand_1', name: { es: 'Forja de Marca', en: 'Brand Forge', fr: 'Forge de Marque' }, type: 'one', price: 750,
    ...
    { 
      id: 'prod_brand_2', name: { es: 'Diseño de Flyer "Spark"', en: 'Flyer Design "Spark"', fr: 'Design de Flyer "Spark"' }, type: 'one', price: 150,
      badge: { es: 'Branding', en: 'Branding', fr: 'Marque' },
    ...
    { 
      id: 'prod_brand_3', name: { es: 'Tarjeta de Presentación Elite', en: 'Elite Business Card', fr: 'Carte de Visite Élite' }, type: 'one', price: 150,
      badge: { es: 'Branding', en: 'Branding', fr: 'Marque' },
    ...
    { 
      id: 'prod_brand_4', name: { es: 'Infografía de Impacto', en: 'Impact Infographic', fr: 'Infographie d\'Impact' }, type: 'one', price: 100,
      badge: { es: 'Branding', en: 'Branding', fr: 'Marque' },
     ...
     { 
      id: 'prod_brand_5', name: { es: 'Menú Digital Interactivo', en: 'Interactive Digital Menu', fr: 'Menu Numérique Interactif' }, type: 'one', price: 400,
      badge: { es: 'Branding', en: 'Branding', fr: 'Marque' },
    ...
    { 
      id: 'prod_brand_6', name: { es: 'Diseño de Packaging Pro', en: 'Pro Packaging Design', fr: 'Design d\'Emballage Pro' }, type: 'one', price: 500,
      badge: { es: 'Branding', en: 'Branding', fr: 'Marque' },
    ...
    { 
      id: 'prod_ent_1', name: { es: 'Escudo de Marca (Trademark)', en: 'Trademark Shield', fr: 'Bouclier de Marque (Trademark)' }, type: 'one', price: 3750,
    ...
    { 
      id: 'prod_ent_2', name: { es: 'Valoración de Negocio', en: 'Business Valuation', fr: 'Évaluation d\'Entreprise' }, type: 'one', price: 17500,
      badge: { es: 'Corporativo', en: 'Corporate', fr: 'Corporatif' },
    ...
    { 
      id: 'prod_ent_3', name: { es: 'Creación de Fundación', en: 'Foundation Setup', fr: 'Création de Fondation' }, type: 'one', price: 10000,
      badge: { es: 'Corporativo', en: 'Corporate', fr: 'Corporatif' },
