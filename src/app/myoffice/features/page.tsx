...
const featureGroups = [
  ...
  { title: '📊 Marketing & Growth', keys: [
    'LEAD_CAPTURE_FORMS', 'FUNNELS_BUILDER', 'EMAIL_MARKETING_BASIC', 'EMAIL_MARKETING_ADVANCED', 'WHATSAPP_INTEGRATION', 'CRM_LIGHT', 'CAMPAIGN_TRACKING', 'UTM_MANAGER', 'AB_TESTING', 'AGENCY_WHITE_LABEL', 'ON_DEMAND_STUDIO', 'CUSTOM_PACKAGE_BUILDER'] },
