...
const featureNames = {
  es: {
    ...
    'ai_campaign_planner': 'Planificador de Campañas con IA',
    'ai_marketing_assistant': 'Asistente de Marketing con IA',
    'ai_business_diagnosis': 'Diagnóstico de Negocio con IA',
    'ai_form_auto_builder': 'Constructor Automático de Formularios con IA',
    'ai_copywriting_longform': 'Copywriting Extenso con IA',
    'ai_multilingual_generation': 'Generación Multilingüe con IA',
    'ai_image_generation': 'Generación de Imágenes con IA',
    'ai_content_scheduler': 'Programador de Contenido con IA',
    'ai_insights_and_recommendations': 'Insights y Recomendaciones con IA',
    'visual_editor_v2': 'Editor Visual V2',
    'drag_and_drop_sections': 'Secciones de Arrastrar y Soltar',
